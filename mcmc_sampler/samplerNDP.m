...
%align the data by removing individual mean
for isub = 1:NSUB
    ...
    %rot_submean = mean(input_data{isub}.Rots,2);
    %input_data{isub}.Rots = input_data{isub}.Rots-rot_submean*ones(1,size(input_data{isub}.Rots,2));
end
...
for isub = 1:NSUB
     ...
     comp3all = [comp3all,input_data{isub}.Rots];
...
for isub = 1:NSUB
     ...
     input_data{isub}.Rots = input_data{isub}.Rots-mean_comp3*ones(1,size(input_data{isub}.Rots,2));
end
...
for i=1:3
     ...
     input_data{isub}.Rots(i,:) = input_data{isub}.Rots(i,:)./sqrt(varc3(i));
end
end
...
if(strcmp(option.COMP1, 'fpca'))
    ...
    component2 = trans;
    component3 = rots;
elseif(strcmp(option.COMP1, 'rots'))
    component1 = rots;
    component2 = fpca_coeff;
    component3 = trans;
elseif(strcmp(option.COMP1, 'trans'))
    component1 = trans;
    component2 = fpca_coeff;
    component3 = rots;
else
    display('please specify the first component using fpca, rots or trans.');
end
